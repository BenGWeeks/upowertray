...
1. [x] Create GitHub release for v1.1.0
2. [x] Submit to AUR - https://aur.archlinux.org/packages/upowertray
3. [x] Set up PPA for Ubuntu - https://launchpad.net/~bengweeks/+archive/ubuntu/upowertray
4. [-] Flatpak - Not planned. System tray apps have integration issues due to sandboxing (StatusNotifierItem DBus portal permissions). PPA and AUR cover the main use cases.
